...
from src.lab3.data.cleanlab_denoiser import IMDBCleanlabAuditor
...
def test_cleanlab_audit_mock():
    ...
    results = auditor.audit_label_errors(pred_probs, labels, texts, output_json="experiments/lab3/results/test_cleanlab.json")
