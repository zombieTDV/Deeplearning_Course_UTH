...
from src.training.imdb_sentiment_train import _full_state, _get_llrd_optimizer_grouped_parameters
from src.utils.checkpoint_utils import average_checkpoints, safe_load_checkpoint, save_checkpoint
...
def test_full_state_callback_best_metric_accuracy():
    ...
    from src.training.imdb_sentiment_train import FullStateCallback
