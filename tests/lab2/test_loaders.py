...
from src.lab2.data.dataloader import _ApplyTransform, _config_defaults, get_cifar10_loaders
from tests.lab2.conftest import requires_data
...
def test_get_cifar10_loaders_counts_and_shapes():
    train_loader, val_loader, test_loader = get_cifar10_loaders(
        batch_size=8, num_workers=0, data_root=str(__import__("pathlib").Path(
            __file__).resolve().parents[2] / "data" / "raw"))
