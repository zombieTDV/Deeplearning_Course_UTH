...
- **Implementation status** — `src/data/eda_imdb.py` and
  `src/experiments/baseline_imdb_sentiment.py` are **implemented** (Exercise 1;
  roadmap Phases 1, 2, 4 done); training/eval/model modules remain **planned**
  (Phases 3, 5–7). See
