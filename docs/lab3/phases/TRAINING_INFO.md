...
- What "done" looks like, concretely:
  ...
  - Smoke test passes on a tiny subset (VRAM verified ≤3.5 GB).
...
4. Run the smoke test on a tiny subset per [SMOKE_TEST_CHECKLIST.md](../templates/SMOKE_TEST_CHECKLIST.md); verify VRAM ≤3.5 GB.
...
- fp16 + gradient accumulation keep VRAM ≤3.5 GB (roadmap risk R1).
