...
_LAZY_EXPORTS: dict[str, str] = {
    ...
    "compute_comprehensive_benchmark": "src.eval.evaluate_model",
    "compute_model_metrics": "src.eval.evaluate_model",
    "evaluate": "src.eval.evaluate_model",
    "format_ascii_metrics_table": "src.eval.evaluate_model",
    "plot_metrics_heatmap_table": "src.eval.evaluate_model",
