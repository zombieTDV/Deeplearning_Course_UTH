...
from src.lab3.utils.checkpoint_utils import safe_load_checkpoint
from src.lab3.utils.resource_monitor import ResourceMonitor, cleanup_vram
...
def _resolve_checkpoint(checkpoint: str | None, run_root: str) -> tuple[Path, dict[str, Any] | None]:
    ...
    from src.lab3.utils.checkpoint_utils import resolve_run_files
...
def evaluate(
    ...
    processed_dir = data_cfg.get("processed_dir", "data/lab3/processed/imdb_tokenized")
    ...
    results_dir = Path("experiments/lab3/results")
    ...
    plots_dir = Path("experiments/lab3/plots")
...
def main() -> None:
    ...
    parser.add_argument("--run-root", default="experiments/lab3/runs")
