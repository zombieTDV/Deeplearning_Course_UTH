...
class IMDBEvaluator:
    ...
    def evaluate_zero_shot_baseline(self) -> dict[str, Any]:
        ...
        baseline_path = self.project_root / "experiments" / "lab3" / "results" / "baseline_imdb_sentiment.json"
        if not baseline_path.exists():
            print("Running zero-shot baseline evaluation script...")
            cmd = [sys.executable, "-m", "src.lab3.experiments.baseline_imdb_sentiment", "--eval-imdb"]
            env = os.environ.copy()
    ...
    def evaluate_latest_checkpoint(self, verbose_5w1h: bool = False, force: bool = False) -> dict[str, Any]:
        ...
        eval_json_path = self.project_root / "experiments" / "lab3" / "results" / "imdb_sentiment_eval.json"
        if not eval_json_path.exists() or force:
            ...
            eval_cmd = [sys.executable, "-m", "src.lab3.eval.evaluate_model"]
            try:
        ...
        if eval_json_path.exists():
            ...
            cm_plot = self.project_root / "experiments" / "lab3" / "plots" / "imdb_finetuned_confusion_matrix.png"
            if cm_plot.exists():
    ...
    def _load_finetuned_accuracy(self) -> float | None:
        ...
        eval_path = self.project_root / "experiments" / "lab3" / "results" / "imdb_sentiment_eval.json"
    ...
    def render_comparison_table(self) -> None:
        ...
        baseline_path = self.project_root / "experiments" / "lab3" / "results" / "baseline_imdb_sentiment.json"
        finetuned_path = self.project_root / "experiments" / "lab3" / "results" / "imdb_sentiment_eval.json"
    ...
    def render_comprehensive_benchmark(self) -> dict[str, dict[str, Any]]:
        ...
        from src.lab3.eval.evaluate_model import format_ascii_metrics_table, plot_metrics_heatmap_table
        ...
        res_dir = self.project_root / "experiments" / "lab3" / "results"
        ...
        plots_dir = self.project_root / "experiments" / "lab3" / "plots"
