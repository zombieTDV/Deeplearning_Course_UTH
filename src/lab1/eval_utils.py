...
_DEFAULT_METRICS_DIR = str(Path(__file__).resolve().parents[2] / 'experiments' / 'lab1' / 'practice_1' / 'metrics')
METRICS_DIR = _DEFAULT_METRICS_DIR if os.path.exists(_DEFAULT_METRICS_DIR) else '../outputs/practice_1/metrics'
