...
class IMDBCleanlabAuditor:
    ...
    def __init__(
        ...
        processed_dir: str = "data/processed/imdb_tokenized_512",
    ...
    def _resolve_highest_accuracy_checkpoint(self) -> tuple[Path, float, str]:
        ...
        runs_dir = self.project_root / "experiments" / "runs"
    ...
    def compute_train_probabilities(
        ...
        cache_meta = self.project_root / "experiments" / "results" / "imdb_train_cache_meta.json"
    ...
    def compute_oof_probabilities(
        ...
        cache_meta = self.project_root / "experiments" / "results" / "imdb_oof_train_cache_meta.json"
    ...
    def audit_label_errors(
        ...
        labels: np.ndarray,
        texts: list[str],
        output_json: str | Path = "experiments/results/cleanlab_label_issues.json",
    ) -> dict[str, Any]:
    ...
    def plot_audit_overview(
        ...
        save_path: str | Path = "experiments/plots/cleanlab_label_audit.png",
    ) -> None:
    ...
    def export_denoised_dataset(
        ...
        output_dir: str | Path = "data/processed/imdb_denoised_512",
    ) -> Path:
